...
#extract BIC scores
BICs<-c(m_VEI_8$BIC[1],m_VEE_8$BIC[1],m_VEI_9$BIC[1],m_VEE_9$BIC[1],m_VEE_10$BIC[1],m_VEE_11$BIC[1],m_VEI_10$BIC[1],m_VEI_11$BIC[1])
...
output <- clustCombi(data = dat_pcs, modelName = "VEE", G = 11)
...
### Change this value to pick a diffreent model
## currently the VEE with 11 clusters is the best model.

write.csv(m_VEE_11$classification,file=here("results/cluster_assignment_pca.csv"))
